def homework(train_X, train_y, test_X):
    ...
    train_X_con = np.concatenate((train_X, cropped_train_X), axis=0)
    train_y_con = np.concatenate((train_y, train_y), axis=0)
    train_X = np.concatenate((train_X_con, flip_train_X), axis=0)
    train_y = np.concatenate((train_y_con, train_y), axis=0)
